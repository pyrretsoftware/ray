...
var processErrorPage = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <div class="center">
        <div class="graphic">
            <div class="item">
                ...
                <span>Client (you):<span class="working"> working</span></span>
            </div class="item">
            ...
            <div class="item">
                ...
                <span>Ray:<span class="working"> working</span></span>
            </div>
            ...
            <div class="item">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-server-icon lucide-server"><rect width="20" height="8" x="2" y="2" rx="2" ry="2"/><rect width="20" height="8" x="2" y="14" rx="2" ry="2"/><line x1="6" x2="6.01" y1="6" y2="6"/><line x1="6" x2="6.01" y1="18" y2="18"/></svg>                <span>Service:<span class="down"> offline</span></span>
            </div>
        </div>
        <div class="text">
            <h1>Web server is offline</h1>
            <p>The underlying process that is responsible for hosting this service has gone offline. It could be because of an application bug, an issue with routing your request between different servers, or something else. If this service has a status page, consider checking that.</p>
